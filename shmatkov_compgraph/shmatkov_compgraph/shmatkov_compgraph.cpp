...
GLfloat points[] = {
    ...
    -0.8f, -0.5f,  0.0f,  // Нижний левый
     0.8f, -0.5f,  0.0f   // Нижний правый
};
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Установка цвета фона (1.0, 1.0, 0.3)
        ...
        // Установка цвета трапеции (0.5, 0.5, 1.0)
        shader.setUniform("ourColor", 0.5f, 0.5f, 1.0f, 1.0f);
